...
#else
    static constexpr size_t REMOTE_PORT = 8081; // standard HTTP port
#endif // MBED_CONF_APP_USE_TLS_SOCKET
...
public:
    ...
    void run()
    {
        ...
        address.set_ip_address("192.168.239.64");
        address.set_port(REMOTE_PORT);
        printf("My ip address %s: ",address.get_ip_address());
        ...
        while (1){
            ...
            int len = sprintf(acc_json,"{\"x\":%f,\"y\":%f,\"z\":%f,\"gx\":%f,\"gy\":%f,\"gz\":%f,\"s\":%d}",(float)((int)(x*10000))/10000,
                                            (float)((int)(y*10000))/10000, (float)((int)(z*10000))/10000,(float)((gx*10000))/10000,(float)((int)(gy*10000))/10000,(float)((int)(gz*10000))/10000, sample_num);
